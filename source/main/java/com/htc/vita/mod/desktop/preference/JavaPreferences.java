...
public class JavaPreferences extends Preferences {
    private Map<String, String> mProperties = new HashMap<String, String>();
    private final JavaPreferenceStorage mPreferenceStorage;

    protected JavaPreferences(
            String category,
            String label) {
        super(
                category,
        ...
        mPreferenceStorage = new JavaPreferenceStorage(
                category,
                label
        );
    }
    ...
    protected Preferences onInitialize() {
        mProperties = mPreferenceStorage.loadFromFile();
        return this;
    }
    ...
    protected boolean onSave() {
        return mPreferenceStorage.saveToFile(mProperties);
    }
}
